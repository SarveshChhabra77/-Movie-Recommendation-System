...
# This code lets your frontend (Streamlit website) talk to your backend (FastAPI server).
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # any website can call your API (good for local testing)
    allow_credentials=True, #allow cookies/login info
    allow_methods=["*"], #allow GET, POST, PUT, DELETE etc.
    allow_headers=["*"], #allow sending data (JSON, files, tokens)
)
